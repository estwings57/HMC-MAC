...
static unsigned atmMUL = 3;			//(HMC clock)Multiplication operation latency
static unsigned atmFMUL = 4;		//(HMC clock)Floating-point multiplication operation latency
