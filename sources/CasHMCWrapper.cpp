...
{
	settingOut<<"****************************************************************"<<endl;
	settingOut<<"*                      HMC-MAC version 1.0                     *"<<endl;
...
void CasHMCWrapper::PrintFinalStatistic()
{
	...
	resultOut<<"****************************************************************"<<endl;
	resultOut<<"*                      HMC-MAC version 1.0                     *"<<endl;
	...
	resultOut<<"  ============= HMC-MAC statistic result ============="<<endl<<endl;
