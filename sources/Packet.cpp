...
#ifdef HMC_MAC
		case MX4B:		header = "[P" + id.str() + "-M_X4B]";	break;
		case MX8B:		header = "[P" + id.str() + "-M_X8B]";	break;
		case MX16B:		header = "[P" + id.str() + "-M_X16B]";	break;
		case ML4B:		header = "[P" + id.str() + "-M_L4B]";	break;
		case ML8B:		header = "[P" + id.str() + "-M_L8B]";	break;
		case ML16B:		header = "[P" + id.str() + "-M_L16B]";	break;
#endif
		//Respond commands
